...
namespace TheVoidOfficial2
{
    public class Startup
    {
        ...
        {
            //services.AddDbContext<ApplicationDbContext>(options => { options.UseSqlite("Data Source = TheVoidOfficalDB.db"); }

            //);

            services.AddDbContextFactory<ApplicationDbContext>(options =>
            {
                options.UseSqlite("Data Source = TheVoidOfficalDB.db");
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMiddleware<BlazorLoginMiddleware.BlazorCookieLoginMiddleware>();
